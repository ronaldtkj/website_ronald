                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                        $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM keluar k, barang s where s.idbarang=k.idbarang");
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Tombol Delete -->
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?=$idkeluar;?>">Delete</button>
                                        </td>
                                    </tr>

                                    <!-- Modal hapus Barang -->
                                    <div class="modal fade" id="hapus<?=$idkeluar;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="delete.php">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" name="idk" value="<?=$idkeluar;?>">
                                                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <input class="form-control mb-3" type="text" name="penerima" placeholder="penerima" required>
                </div>
                <div class="modal-footer">
